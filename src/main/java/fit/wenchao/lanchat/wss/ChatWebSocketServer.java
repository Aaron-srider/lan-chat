package fit.wenchao.lanchat.wss;

import static fit.wenchao.lanchat.utils.json.Json.*;
...
import fit.wenchao.lanchat.constants.BusinessType;
import fit.wenchao.lanchat.constants.ContentType;
import fit.wenchao.lanchat.model.chat.Message;
import fit.wenchao.lanchat.model.chat.User;
import fit.wenchao.lanchat.utils.WebsocketUtil;
...
public class ChatWebSocketServer {
    ...
    private static Logger log = LoggerFactory.getLogger(ChatWebSocketServer.class);
    ...
    public void onOpen(Session session) throws IOException {
        ...
        JSONObject userOnlineResp = json(
                pair("you", this.user),
